...
const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(ALOLAN_TRIFOX, gMonPalette_AlolanTrifox),
    ...
    SPECIES_PAL(ALOLAN_MEOWSY, gMonPalette_AlolanMeowsy),
    ...
    SPECIES_PAL(GALARIAN_MINICORN, gMonPalette_GalarianMinicorn),
    SPECIES_PAL(GALARIAN_PONYTA, gMonPalette_GalarianPonyta),
    SPECIES_PAL(GALARIAN_RAPIDASH, gMonPalette_GalarianRapidash),
    ...
    SPECIES_PAL(CHICKS, gMonPalette_Chicks),
    ...
    SPECIES_PAL(ALOLAN_GRIMEY, gMonPalette_AlolanGrimey),
    ...
    SPECIES_PAL(TURBAN, gMonPalette_Turban),
    ...
    SPECIES_PAL(GOLPPY, gMonPalette_Golppy),
    ...
    SPECIES_PAL(GALARIAN_OBSTAGOON, gMonPalette_GalarianObstagoon),
    ...
    SPECIES_PAL(CLONE_BULBASAUR, gMonPalette_CloneBulbasaur),
    SPECIES_PAL(CLONE_IVYSAUR, gMonPalette_CloneIvysaur),
    SPECIES_PAL(CLONE_VENUSAUR, gMonPalette_CloneVenusaur),
    SPECIES_PAL(CLONE_CHARMANDER, gMonPalette_CloneCharmander),
    SPECIES_PAL(CLONE_CHARMELEON, gMonPalette_CloneCharmeleon),
    SPECIES_PAL(CLONE_CHARIZARD, gMonPalette_CloneCharizard),
    SPECIES_PAL(CLONE_SQUIRTLE, gMonPalette_CloneSquirtle),
    SPECIES_PAL(CLONE_WARTORTLE, gMonPalette_CloneWartortle),
    SPECIES_PAL(CLONE_BLASTOISE, gMonPalette_CloneBlastoise),
