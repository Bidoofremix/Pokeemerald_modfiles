...
const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(ALOLAN_TRIFOX, gMonFrontPic_AlolanTrifox),
    ...
    SPECIES_SPRITE(ALOLAN_MEOWSY, gMonFrontPic_AlolanMeowsy),
    ...
    SPECIES_SPRITE(GALARIAN_MINICORN, gMonFrontPic_GalarianMinicorn),
    SPECIES_SPRITE(GALARIAN_PONYTA, gMonFrontPic_GalarianPonyta),
    SPECIES_SPRITE(GALARIAN_RAPIDASH, gMonFrontPic_GalarianRapidash),
    ...
    SPECIES_SPRITE(CHICKS, gMonFrontPic_Chicks),
    ...
    SPECIES_SPRITE(ALOLAN_GRIMEY, gMonFrontPic_AlolanGrimey),
    ...
    SPECIES_SPRITE(TURBAN, gMonFrontPic_Turban),
    ...
    SPECIES_SPRITE(GOLPPY, gMonFrontPic_Golppy),
    ...
    SPECIES_SPRITE(GALARIAN_OBSTAGOON, gMonFrontPic_GalarianObstagoon),
    ...
    SPECIES_SPRITE(CLONE_BULBASAUR, gMonFrontPic_CloneBulbasaur),
    SPECIES_SPRITE(CLONE_IVYSAUR, gMonFrontPic_CloneIvysaur),
    SPECIES_SPRITE(CLONE_VENUSAUR, gMonFrontPic_CloneVenusaur),
    SPECIES_SPRITE(CLONE_CHARMANDER, gMonFrontPic_CloneCharmander),
    SPECIES_SPRITE(CLONE_CHARMELEON, gMonFrontPic_CloneCharmeleon),
    SPECIES_SPRITE(CLONE_CHARIZARD, gMonFrontPic_CloneCharizard),
    SPECIES_SPRITE(CLONE_SQUIRTLE, gMonFrontPic_CloneSquirtle),
    SPECIES_SPRITE(CLONE_WARTORTLE, gMonFrontPic_CloneWartortle),
    SPECIES_SPRITE(CLONE_BLASTOISE, gMonFrontPic_CloneBlastoise),
