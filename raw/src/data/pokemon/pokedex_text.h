...
const u8 gTrifoxPokedexText[] = _(
    "Trifox's fur is soft and fluffy, and its\n"
    "white tails curl as it matures. To sleep\n"
    "warm during cold nights, it scorches grass\n"
    "and carries it to its nest.");
...
const u8 gParaPokedexText[] = _(
    "It lives and feeds on mushrooms. A swarm of\n"
    "Para will often squabble on the best fungi.\n"
    "The choice of mushroom will sometimes affect\n"
    "its behaviour and personality.");
...
const u8 gMeowsyPokedexText[] = _(
    "It likes playing with shiny things. It will\n"
    "claim unattended trinkets as its own. Meowsy\n"
    "likes polishing its trainer's BADGES and\n"
    "brags about them to others of its kind.");
...
const u8 gPuddiPokedexText[] = _(
    "A playful and mischievous POKéMON. Though\n"
    "clumsy at birth, Puddi will quickly become\n"
    "energetic and agile. It bonds strongly with\n"
    "its caretaker.");
...
const u8 gChicksPokedexText[] = _(
    ...
    "Itself when in danger. It will loudly demand\n"
    "food from its caretaker, making earplugs\n"
    "a useful asset for trainers.");
...
const u8 gGrimeyPokedexText[] = _(
    "Grimey can be found swarming near sewer\n"
    "pipes, where they feed on wastewater. For\n"
    "some reason, they have recently become very\n"
    "popular among young trainers.");
...
const u8 gTangelPokedexText[] = _(
    "Tangel dwell in dense forests, where they\n"
    "lurk among the undergrowth. They are very\n"
    "timid and will flee at the first sign of\n"
    "danger. Thus, they can be hard to catch.");
...
const u8 gGolppyPokedexText[] = _(
    "It has an easygoing nature. Golppy travel in\n"
    "large schools, which protects them from\n"
    "predators. It plays underwater by blowing\n"
    "bubbles from its mouth and chasing them.");
...
const u8 gCloneBulbasaurPokedexText[] = _(
    "An experimental POKéMON species created by\n"
    "Dr. Fuji. It has a strong intuition and can\n"
    "anticipate its enemy's attacks. It will plan\n"
    "its strategy far ahead before moving.");
...
const u8 gCloneVenusaurPokedexText[] = _(
    "A masterful tactician, it can foresee the\n"
    "events of a battle before it even starts. It\n"
    "will make a surprising move and then deliver\n"
    "a single powerful blow to defeat the enemy.");

const u8 gCloneCharmanderPokedexText[] = _(
    "An experimental POKéMON species created by\n"
    "Dr. Fuji. It has a good endurance and it\n"
    "attacks viciously with its fangs and claws.\n"
    "It will defend itself until exhausted.");

const u8 gCloneCharmeleonPokedexText[] = _(
    "It has a harsh and volatile personality. In\n"
    "exchange for its wicked physical attacks, it\n"
    "has less good skills with fire. This POKéMON\n"
    "is especially difficult to tame.");

const u8 gCloneCharizardPokedexText[] = _(
    "This POKéMON is brutal and merciless. It\n"
    "will keep attacking until explicitly told to\n"
    "stop. Its claws are so sharp that one slash\n"
    "is enough to defeat most opponents.");

const u8 gCloneSquirtlePokedexText[] = _(
    "An experimental POKéMON species created by\n"
    "Dr. Fuji. It has a steady nature and will\n"
    "remain calm in tough situations. It retreats\n"
    "into its shell when in danger.");

const u8 gCloneWartortlePokedexText[] = _(
    "It has nerves of steel. This POKéMON can\n"
    "turn the tide of the battle with defensive\n"
    "strategies. By using its hard shell, it can\n"
    "slowly wear out the enemy.");

const u8 gCloneBlastoisePokedexText[] = _(
    "Its defenses are impervious and nerves\n"
    "unswerving. It can use its water jets for\n"
    "crushing streams or high-speed tackles. It\n"
    "is ambitious to fight the strongest of foes.");
