...
const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_CHICKS] = 
    {
        ...
        .height = 2,
        .weight = 14,
        .description = gChicksPokedexText,
        .pokemonScale = 650,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GOLPPY] = 
    {
        .categoryName = _("TINY FISH"),
        .height = 2,
        .weight = 39,
        .description = gGolppyPokedexText,
        .pokemonScale = 650,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_BULBASAUR] = 
    {
        .categoryName = _("CLONE"),
        .height = 7,
        .weight = 74,
        .description = gCloneBulbasaurPokedexText,
        .pokemonScale = 340,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_IVYSAUR] = 
    {
        .categoryName = _("CLONE"),
        .height = 11,
        .weight = 151,
        .description = gCloneIvysaurPokedexText,
        .pokemonScale = 280,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_VENUSAUR] = 
    {
        .categoryName = _("CLONE"),
        .height = 23,
        .weight = 1138,
        .description = gCloneVenusaurPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 156,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_CHARMANDER] = 
    {
        .categoryName = _("CLONE"),
        .height = 7,
        .weight = 92,
        .description = gCloneCharmanderPokedexText,
        .pokemonScale = 340,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_CHARMELEON] = 
    {
        .categoryName = _("CLONE"),
        .height = 13,
        .weight = 264,
        .description = gCloneCharmeleonPokedexText,
        .pokemonScale = 260,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_CHARIZARD] = 
    {
        .categoryName = _("CLONE"),
        .height = 20,
        .weight = 1297,
        .description = gCloneCharizardPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 180,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_SQUIRTLE] = 
    {
        .categoryName = _("CLONE"),
        .height = 6,
        .weight = 103,
        .description = gCloneSquirtlePokedexText,
        .pokemonScale = 390,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_WARTORTLE] = 
    {
        .categoryName = _("CLONE"),
        .height = 11,
        .weight = 240,
        .description = gCloneWartortlePokedexText,
        .pokemonScale = 280,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CLONE_BLASTOISE] = 
    {
        .categoryName = _("CLONE"),
        .height = 6,
        .weight = 103,
        .description = gCloneBlastoisePokedexText,
        .pokemonScale = 390,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
