...
extern const u32 gMonFrontPic_AlolanTrifox[];
extern const u32 gMonBackPic_AlolanTrifox[];
extern const u32 gMonPalette_AlolanTrifox[];
extern const u32 gMonShinyPalette_AlolanTrifox[];
extern const u8 gMonIcon_AlolanTrifox[];
extern const u8 gMonFootprint_AlolanTrifox[];
...
extern const u32 gMonFrontPic_AlolanMeowsy[];
extern const u32 gMonBackPic_AlolanMeowsy[];
extern const u32 gMonPalette_AlolanMeowsy[];
extern const u32 gMonShinyPalette_AlolanMeowsy[];
extern const u8 gMonIcon_AlolanMeowsy[];
extern const u8 gMonFootprint_AlolanMeowsy[];
...
extern const u32 gMonFrontPic_GalarianMinicorn[];
extern const u32 gMonBackPic_GalarianMinicorn[];
extern const u32 gMonPalette_GalarianMinicorn[];
extern const u32 gMonShinyPalette_GalarianMinicorn[];
extern const u8 gMonIcon_GalarianMinicorn[];
extern const u8 gMonFootprint_GalarianMinicorn[];

extern const u32 gMonFrontPic_GalarianPonyta[];
extern const u32 gMonBackPic_GalarianPonyta[];
extern const u32 gMonPalette_GalarianPonyta[];
extern const u32 gMonShinyPalette_GalarianPonyta[];
extern const u8 gMonIcon_GalarianPonyta[];
extern const u8 gMonFootprint_GalarianPonyta[];

extern const u32 gMonFrontPic_GalarianRapidash[];
extern const u32 gMonBackPic_GalarianRapidash[];
extern const u32 gMonPalette_GalarianRapidash[];
extern const u32 gMonShinyPalette_GalarianRapidash[];
extern const u8 gMonIcon_GalarianRapidash[];
extern const u8 gMonFootprint_GalarianRapidash[];
...
extern const u32 gMonFrontPic_Chicks[];
extern const u32 gMonBackPic_Chicks[];
extern const u32 gMonPalette_Chicks[];
extern const u32 gMonShinyPalette_Chicks[];
extern const u8 gMonIcon_Chicks[];
extern const u8 gMonFootprint_Chicks[];
...
extern const u32 gMonFrontPic_AlolanGrimey[];
extern const u32 gMonBackPic_AlolanGrimey[];
extern const u32 gMonPalette_AlolanGrimey[];
extern const u32 gMonShinyPalette_AlolanGrimey[];
extern const u8 gMonIcon_AlolanGrimey[];
extern const u8 gMonFootprint_AlolanGrimey[];
...
extern const u32 gMonFrontPic_Turban[];
extern const u32 gMonBackPic_Turban[];
extern const u32 gMonPalette_Turban[];
extern const u32 gMonShinyPalette_Turban[];
extern const u8 gMonIcon_Turban[];
extern const u8 gMonFootprint_Turban[];
...
extern const u32 gMonFrontPic_Golppy[];
extern const u32 gMonBackPic_Golppy[];
extern const u32 gMonPalette_Golppy[];
extern const u32 gMonShinyPalette_Golppy[];
extern const u8 gMonIcon_Golppy[];
extern const u8 gMonFootprint_Golppy[];
...
extern const u32 gMonFrontPic_GalarianObstagoon[];
extern const u32 gMonBackPic_GalarianObstagoon[];
extern const u32 gMonPalette_GalarianObstagoon[];
extern const u32 gMonShinyPalette_GalarianObstagoon[];
extern const u8 gMonIcon_GalarianObstagoon[];
extern const u8 gMonFootprint_GalarianObstagoon[];
...
extern const u32 gMonFrontPic_CloneBulbasaur[];
extern const u32 gMonBackPic_CloneBulbasaur[];
extern const u32 gMonPalette_CloneBulbasaur[];
extern const u32 gMonShinyPalette_CloneBulbasaur[];
extern const u8 gMonIcon_CloneBulbasaur[];
extern const u8 gMonFootprint_CloneBulbasaur[];

extern const u32 gMonFrontPic_CloneIvysaur[];
extern const u32 gMonBackPic_CloneIvysaur[];
extern const u32 gMonPalette_CloneIvysaur[];
extern const u32 gMonShinyPalette_CloneIvysaur[];
extern const u8 gMonIcon_CloneIvysaur[];
extern const u8 gMonFootprint_CloneIvysaur[];

extern const u32 gMonFrontPic_CloneVenusaur[];
extern const u32 gMonBackPic_CloneVenusaur[];
extern const u32 gMonPalette_CloneVenusaur[];
extern const u32 gMonShinyPalette_CloneVenusaur[];
extern const u8 gMonIcon_CloneVenusaur[];
extern const u8 gMonFootprint_CloneVenusaur[];

extern const u32 gMonFrontPic_CloneCharmander[];
extern const u32 gMonBackPic_CloneCharmander[];
extern const u32 gMonPalette_CloneCharmander[];
extern const u32 gMonShinyPalette_CloneCharmander[];
extern const u8 gMonIcon_CloneCharmander[];
extern const u8 gMonFootprint_CloneCharmander[];

extern const u32 gMonFrontPic_CloneCharmeleon[];
extern const u32 gMonBackPic_CloneCharmeleon[];
extern const u32 gMonPalette_CloneCharmeleon[];
extern const u32 gMonShinyPalette_CloneCharmeleon[];
extern const u8 gMonIcon_CloneCharmeleon[];
extern const u8 gMonFootprint_CloneCharmeleon[];

extern const u32 gMonFrontPic_CloneCharizard[];
extern const u32 gMonBackPic_CloneCharizard[];
extern const u32 gMonPalette_CloneCharizard[];
extern const u32 gMonShinyPalette_CloneCharizard[];
extern const u8 gMonIcon_CloneCharizard[];
extern const u8 gMonFootprint_CloneCharizard[];

extern const u32 gMonFrontPic_CloneSquirtle[];
extern const u32 gMonBackPic_CloneSquirtle[];
extern const u32 gMonPalette_CloneSquirtle[];
extern const u32 gMonShinyPalette_CloneSquirtle[];
extern const u8 gMonIcon_CloneSquirtle[];
extern const u8 gMonFootprint_CloneSquirtle[];

extern const u32 gMonFrontPic_CloneWartortle[];
extern const u32 gMonBackPic_CloneWartortle[];
extern const u32 gMonPalette_CloneWartortle[];
extern const u32 gMonShinyPalette_CloneWartortle[];
extern const u8 gMonIcon_CloneWartortle[];
extern const u8 gMonFootprint_CloneWartortle[];

extern const u32 gMonFrontPic_CloneBlastoise[];
extern const u32 gMonBackPic_CloneBlastoise[];
extern const u32 gMonPalette_CloneBlastoise[];
extern const u32 gMonShinyPalette_CloneBlastoise[];
extern const u8 gMonIcon_CloneBlastoise[];
extern const u8 gMonFootprint_CloneBlastoise[];
