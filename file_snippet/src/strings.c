...
const u8 gText_EggFromBreedersClub[] = _("A POKéMON EGG obtained\nat the BREEDER's CLUB.");
const u8 gText_EggFromHotSprings[] = _("A POKéMON EGG obtained\nat the hot springs.");
// >

< //
const u8 gText_TM13AndPrice[] = _("TM13{CLEAR_TO 0x48}4,000 COINS");
const u8 gText_FireStoneAndPrice[] = _("Fire Stone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_WaterStoneAndPrice[] = _("Water Stone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_ThunderStoneAndPrice[] = _("ThunderStone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_LeafStoneAndPrice[] = _("Leaf Stone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_MoonStoneAndPrice[] = _("Moon Stone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_SunStoneAndPrice[] = _("Sun Stone{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_ShinyStoneAndPrice[] = _("Shiny Stone{CLEAR_TO 0x48}2,000 COINS");
...
const u8 gText_SideQuestDesc_10[] = _(
	"Win against MASTER TRAINERS\n"
	"of BUG, POISON and GRASS\n"
	"types.");
const u8 gText_SideQuestDesc_11[] = _(
	"Win against MASTER TRAINERS\n"
	"of STEEL, GROUND and ROCK\n"
	"types.");
const u8 gText_SideQuestDesc_12[] = _(
	"Win against MASTER TRAINERS\n"
	"of DARK, GHOST and PSYCHIC\n"
	"types.\n");
const u8 gText_SideQuestDesc_13[] = _(
	"Win against MASTER TRAINERS\n"
	"of NORMAL and FIGHTING\n"
	"types.");
const u8 gText_SideQuestDesc_14[] = _(
	"Win against MASTER TRAINERS\n"
...
const u8 gText_SideQuestPOC_10[] = _("???");
const u8 gText_SideQuestPOC_11[] = _("???");
const u8 gText_SideQuestPOC_12[] = _("???");
...
const u8 gText_SideQuestPOC_21[] = _("OLD MAN");
...
const u8 gText_SideQuestMap_10[] = _("???");
const u8 gText_SideQuestMap_11[] = _("???");
const u8 gText_SideQuestMap_12[] = _("???");
...
const u8 gText_SideQuestMap_21[] = _("ROUTE 109");
...
const u8 gText_SideQuestReward_5[] = _("Moon Balls");
...
const u8 gText_SideQuestReward_21[] = _("Tutor: Shore Up");
