...
const u32 gItemIcon_IgnisBall[] = INCBIN_U32("graphics/items/icons/ignis_ball.4bpp.lz");
const u32 gItemIconPalette_IgnisBall[] = INCBIN_U32("graphics/items/icon_palettes/ignis_ball.gbapal.lz");
