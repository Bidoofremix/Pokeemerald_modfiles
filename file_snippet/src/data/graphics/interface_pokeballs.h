...
const u32 gInterfaceGfx_CloneBall[] = INCBIN_U32("graphics/interface/ball/clone.4bpp.lz");
const u32 gInterfacePal_CloneBall[] = INCBIN_U32("graphics/interface/ball/clone.gbapal.lz");
...
const u32 gInterfaceGfx_IgnisBall[] = INCBIN_U32("graphics/interface/ball/ignis.4bpp.lz");
const u32 gInterfacePal_IgnisBall[] = INCBIN_U32("graphics/interface/ball/ignis.gbapal.lz");
