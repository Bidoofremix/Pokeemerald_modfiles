...
const struct TrainerBall gTrainerBallTable[] = {
    {TRAINER_CLASS_TEAM_AQUA, ITEM_LURE_BALL},
    {TRAINER_CLASS_AQUA_ADMIN, ITEM_LURE_BALL},
    ...
    {TRAINER_CLASS_KINDLER, ITEM_IGNIS_BALL},
    ...
    {TRAINER_CLASS_DRAGON_TAMER, ITEM_IGNIS_BALL},
    ...
    {TRAINER_CLASS_TEAM_MAGMA, ITEM_IGNIS_BALL},
    {TRAINER_CLASS_MAGMA_ADMIN, ITEM_IGNIS_BALL},
	...
	{TRAINER_CLASS_MEWTWO, ITEM_CLONE_BALL},
    {0xFF, ITEM_POKE_BALL},
};
